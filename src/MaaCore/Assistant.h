...
public:
    ...
    int page_transition_timeout_seconds() const noexcept { return m_page_transition_timeout_seconds; }
...
private:
    ...
    std::atomic_int m_page_transition_timeout_seconds = 10;
    std::atomic_int m_battle_start_timeout_seconds = 60;
